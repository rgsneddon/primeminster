...
/**
 * Lightweight chart config — no Chart.js CDN, no canvas animations.
 * Used by the page and structural tests.
 */
...
/**
 * Build a simple horizontal bar chart as SVG markup (no Chart.js).
 * @param {string[]} labels
 * @param {number[]} values
 * @param {string[]} [colors]
 * @param {{ max?: number, width?: number, rowH?: number }} [opts]
 */
...
/**
 * Cap history for light rendering.
